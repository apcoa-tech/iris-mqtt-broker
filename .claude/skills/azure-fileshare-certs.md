...
Skill for managing certificates stored in Azure File Shares for the IRIS MQTT broker infrastructure.

## Overview

The MQTT broker uses Azure File Shares to store certificates, configurations, data, and logs. This skill provides commands for finding, downloading, and managing certificates in these shares.
